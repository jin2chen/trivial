...
if exists("php_parent_error_open")
  if exists("php_noShortTags")
    syn region   phpRegion  matchgroup=SpecialKey start="<?php" end="?>" contains=@phpClTop
  else
    syn region   phpRegion  matchgroup=SpecialKey start="<?\(php\)\=" end="?>" contains=@phpClTop
  endif
  ...
  if exists("php_noShortTags")
    syn region   phpRegion  matchgroup=SpecialKey start="<?php" end="?>" contains=@phpClTop keepend
  else
    syn region   phpRegion  matchgroup=SpecialKey start="<?\(php\)\=" end="?>" contains=@phpClTop keepend
  endif
