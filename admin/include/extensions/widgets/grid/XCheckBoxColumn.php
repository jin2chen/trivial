...
/**
 * XCheckBoxColumn represents a grid view column of checkboxes.
 *
 * XCheckBoxColumn supports no selection (read-only), single selection and multiple selection.
 ...
 *
 * @author Qiang Xue <qiang.xue@gmail.com>
 * @version $Id: XCheckBoxColumn.php 135 2011-07-20 12:01:55Z mole1230 $
 * @package zii.widgets.grid
 * @since 1.1
 */
class XCheckBoxColumn extends XGridColumn
{
	/**
